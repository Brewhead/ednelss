...
message.channel.send(new MessageEmbed().setDescription(`${message.author} Tarafından. Adlı Kullanıcı ${kullanici} \`${sebep}\` Sebebinden Dolayı Banlandı.`).setImage("https://cdn.discordapp.com/attachments/717041569345175582/751012948482457600/d497ce2e25cbe57c7360cc29b7f56d49.gif").setAuthor(message.member.displayName, message.author.avatarURL({dynamic: true})).setColor('0x348f36').setTimestamp()) 
banlog.send(new MessageEmbed().setAuthor(message.member.displayName, message.author.avatarURL({dynamic: true})).setColor('red').setTimestamp().setDescription(`**Sunucudan Yasaklandı !**\n**Banlayan Yetkili:** ${message.author} \n**Banlanan Üye:** ${kullanici.user} \n**Banlanan Üye İd:**\`${kullanici.user.id}\`\n**Banlanma Nedeni:**\`${sebep}\`\n**Tarih:** \`${moment(Date.now()).add(10,"hours").format("HH:mm:ss DD MMMM YYYY")}\` `).setImage("https://cdn.discordapp.com/attachments/717041569345175582/751012948482457600/d497ce2e25cbe57c7360cc29b7f56d49.gif"));
}
